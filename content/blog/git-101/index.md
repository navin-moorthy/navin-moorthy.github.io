...
![Responsive image](git&github.png)
...
![Three areas of git](working.png)
...
![image of a main branch and new side branch](branches.jpg)
...
##### Link your Project to [github.com](https://github.com)
...
Thanks to [Ian Schoonover](https://www.youtube.com/channel/UCqo2YWBtmFSWhuUk4WEyfGg) for the guide.
...
![repository creation screenshot](newrepo.PNG)

![repository creation screenshot](createrepo.png)
...
![branch creation screenshot](newbrach.PNG)
...
![edited screenshot](edit.PNG)

![commited screenshot](commit.PNG)
...
![pull request screenshot](pullrequest.PNG)

![pull confirm screenshot](createrpull.PNG)
...
![merging screenshot](mergepull.PNG)

### Complete flow

![complete flow](createbranch.png)

![complete flow](pullmerge.png)

##### Thanks to [GitHub Guides](https://guides.github.com/) for the article reference.
